...
class Car(arcade.Sprite):
    ...
    def update(self):
        ...
        #braking distance
            ...
            elif(self.car_who_blocked_me.message == None): # obrigar o que o bloqueou a andar
        ...
        #inside intersection
            ...
            for car in cars_inside:
                ...
                if(len(common)>0):
                    ...
                    if(mine_n_iterations < other_n_iterations): # a minha distancia é menor que a do outro
